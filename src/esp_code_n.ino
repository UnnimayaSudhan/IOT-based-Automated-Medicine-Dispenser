...
#define USER_EMAIL "device2@autobonics.com"
...
void streamCallback(StreamData data)
{
  ...
  if (isrWorkModFB.success)
  {
    ...
    if (stepper1.success)
  {
    Serial.println("Success data stepper1");
    int value = stepper1.to<bool>(); 
    isStepper1Rotate = value; 
  }
    if (stepper2.success)
  {
    Serial.println("Success data stepper2");
    int value = stepper2.to<bool>(); 
